...
const Packs = () => {
  ...
  const handleCreatePack = (e) => {
    ...
    const newPack = {
      ...
      createdById: user.id,
      members: [user.id],
      image: formData.uploadedImage || 'https://images.unsplash.com/photo-1760555961058-fd625e6a0b6d?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2NDJ8MHwxfHNlYXJjaHwyfHxtb3RvcmN5Y2xlJTIwcmlkZXIlMjBuaWdodCUyMGNpdHklMjBuZW9uJTIwbGlnaHRzJTIwY2luZW1hdGljfGVufDB8fHx8MTc3MTM5MTc3N3ww&ixlib=rb-4.1.0&q=85',
      upcomingRides: 0,
      scheduledRides: [],
